...
def draw_skeleton_3d(ax, positions, roles, title, annotate=False, edges=EDGES):
...
def main():
    parser = argparse.ArgumentParser(description="Visualize canonical human and Alex robot in one 3D view each.")
    ...
    if args.output is None:
        out_path = npz_path.with_name(npz_path.stem + "_oneview.gif")
    else:
