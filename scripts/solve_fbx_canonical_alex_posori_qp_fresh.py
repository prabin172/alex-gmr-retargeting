...
def make_orientation_targets_for_frame(src_ori_mats, ori_to_idx, first_src_ori_mats, target_rest_orientations):
    """
    Local orientation delta transfer:
      delta_local = R_source_rest.T @ R_source_current
      R_target = R_alex_rest @ delta_local
    """
    targets = {}
    for role in ORI_TO_ALEX_BODY:
        ...
        delta_local = R0.T @ Rt
        targets[role] = target_rest_orientations[role] @ delta_local
    return targets
